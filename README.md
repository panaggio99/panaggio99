...
Junior Data Scientist (Москва). Строю ML-модели с фокусом на предотвращение утечек данных (Data Leakage) и перевод качества модели в реальные бизнес-метрики.
